...
using Concordia.Modules.Admin;
using Concordia.Modules.Colors;
using Concordia.Modules.Feeds;
using Concordia.Modules.Github;
using Concordia.Modules.Modules;
using Concordia.Modules.Public;
using Concordia.Modules.Status;
using Concordia.Modules.Twitch;
...
namespace Concordia
{
    public class Program
    {
        ...
        private const string AppName = "Concordia";
        private const string AppUrl = "https://github.com/cuken/Concordia";
