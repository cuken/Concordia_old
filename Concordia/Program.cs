            ...
            var worker = new Thread(() =>
            {
                ...
                client.TextClientDebugMessageReceived += (sender, e) =>
                {
                    if (e.message.Level == MessageLevel.Error || e.message.Level == MessageLevel.Error || e.message.Level == MessageLevel.Warning)
                    {
                        ...
                        {
                            DiscordMember onwer = client.GetServersList().Find(x => x.members.Find(y => y.Username == "Cuken") != null).members.Find(x => x.Username == "Cuken");
                            if (onwer != null)
                ...
                client.UnknownMessageTypeReceived += (sender, e) =>
                {
                    ...
                    client.SendMessageToUser("Heya, a new message type, '" + e.RawJson["t"].ToString() + "', has popped up!", client.GetServersList().Find(x => x.members.Find(y => y.Username == "Cuken") != null).members.Find(x => x.Username == "Cuken"));
                };
                ...
                client.MessageEdited += (sender, e) =>
                {
                    ...
                    //if (e.author.user.username == "Cuken")
                ...
                client.MentionReceived += (sender, e) =>
                {
                    ...
                    DiscordMember owner = client.GetServersList().Find(x => x.members.Find(y => y.Username == "Cuken") != null).members.Find(x => x.Username == "Cuken");
                ...
                client.MessageReceived += (sender, e) =>
                {
                    ...
                    else if (e.message.content.StartsWith("?makeroll"))
                    {
                        ...
                        foreach (var role in me.Roles)
                        {
                            if (role.permissions.HasPermission(DiscordSpecialPermissions.ManageRoles))
                            {
                                ...
                                newRole.color = new Concordia.Color("0xFF0000");
                    ...
                    else if (e.message.content.StartsWith("?assignrole"))
                    {
                        ...
                        if (hasPermission)
                        {
                            ...
                            if (split.Length > 0)
                            {
                                ...
                                if (toAssign != null)
                                {
                                    client.AssignRoleToMember(server, toAssign, server.members.Find(x => x.Username == "Cuken"));
                                }
                                else
                                {
                    ...
                    {
                        var msg = client.SendMessageToUser("lmao you suck", client.GetServersList()[0].members.Find(x => x.Username == "Cuken"));
                    ...
                    else if (e.message.content.StartsWith("?testvoice"))
                    {
                        ...
                        if (played)
                        {
                            client.VoiceQueueEmpty += (sx, ex) =>
                            {
                                ...
                                string fileToPlay = availableSongs[rng.Next(availableSongs.Count - 1)];
                                client.GetServersList().Find(x => x.name == "Cuken's Test Server").channels.Find(x => x.Name == "testing" && x.Type == ChannelType.Text).SendMessage($"Playing `{Path.GetFileName(fileToPlay)}`");
                                VoiceStuffs(client.GetVoiceClient(), fileToPlay);
                            };
                        }
                    }
                    ...
                    {
                        if (e.author.Username == "Cuken" || e.author.Username == "Uniquoooo")
                        {
                            string[] split = e.message.content.Split(new char[] { ' ' }, 2);
                            if (split.Length > 1)
                            {
                    ...
                    {
                        DiscordMember member = e.Channel.parent.members.Find(x => x.Username == "Cuken");
                        /*using (var lllfclient = new LastfmClient(lastfmAuthentication))
                        {
                            try
                            {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                client.SendMessageToUser(whatToSend, client.GetServersList().Find(x => x.members.Find(y => y.Username == "Cuken") != null).members.Find(x => x.Username == "Cuken"));
                            }
                        }*/
                    }
                };
                ...
                client.Connected += (sender, e) =>
                {
                    ...
                    owner = client.GetServersList().Find(x => x.members.Find(y => y.Username == "Cuken") != null).members.Find(x => x.Username == "Cuken");
                };
